...
- **flattenTreeToLeaves()** (2 connections) — `src/func/blueprints.js`
- **getCachedBlueprintMaterials()** (2 connections) — `src/func/blueprints.js`
- **renderFlatMaterialList()** (2 connections) — `src/func/blueprints.js`

## Relationships

- [Blueprint Library](Blueprint_Library.md) (6 shared connections)
- [Blueprints](Blueprints.md) (1 shared connections)

...
- **windowSize()** (3 connections) — `src/demo_mode.js`
- **redirectPaths()** (3 connections) — `src/demo_mode.js`
- **reset()** (3 connections) — `src/demo_mode.js`
- **setEnabled()** (2 connections) — `src/demo_mode.js`
- **fs** (1 connections) — `src/demo_mode.js`
- **path** (1 connections) — `src/demo_mode.js`
- **DEFAULT_SIZE** (1 connections) — `src/demo_mode.js`
- **test** (1 connections) — `test/demo_mode.test.js`
- **assert** (1 connections) — `test/demo_mode.test.js`
- **fs** (1 connections) — `test/demo_mode.test.js`
- **os** (1 connections) — `test/demo_mode.test.js`
- **path** (1 connections) — `test/demo_mode.test.js`

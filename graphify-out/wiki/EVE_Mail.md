...
- **_mailRenderList()** (8 connections) — `src/func/mail.js`
- **_mailOpen()** (8 connections) — `src/func/mail.js`
- **_mailIsAll()** (7 connections) — `src/func/mail.js`
- **initMailPage()** (7 connections) — `src/func/mail.js`
- **_mailBindStaticControls()** (7 connections) — `src/func/mail.js`
- **_mailCompose()** (6 connections) — `src/func/mail.js`
- **_mailCharName()** (5 connections) — `src/func/mail.js`
- **_mailRenderCharPicker()** (5 connections) — `src/func/mail.js`
- **_mailRenderLabels()** (5 connections) — `src/func/mail.js`
- **_mailDelete()** (5 connections) — `src/func/mail.js`
- **_mailSendCompose()** (5 connections) — `src/func/mail.js`

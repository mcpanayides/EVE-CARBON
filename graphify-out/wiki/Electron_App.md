...
- **electron-app.js** (36 connections) — `e2e/support/electron-app.js`
- **seed.js** (5 connections) — `e2e/fixtures/seed.js`
- **mining.spec.js** (3 connections) — `e2e/mining.spec.js`
...
- **{ test, expect }** (1 connections) — `e2e/mining.spec.js`
- **base** (1 connections) — `e2e/support/electron-app.js`
- **{ _electron: electron }** (1 connections) — `e2e/support/electron-app.js`
...
- [Calendar Spec](Calendar_Spec.md) (11 shared connections)

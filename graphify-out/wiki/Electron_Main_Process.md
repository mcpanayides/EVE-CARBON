...
- **resfileBackgrounds** (1 connections) — `main.js`
- **sdeFetch** (1 connections) — `main.js`
- *... and 54 more nodes in this community*

## Relationships

- [Main Process ESI & Cache Layer](Main_Process_ESI_%26_Cache_Layer.md) (28 shared connections)
- [Electron Main Process (appIconPath)](Electron_Main_Process_%28appIconPath%29.md) (13 shared connections)
- [Electron Main Process (_esiCompatHeader)](Electron_Main_Process_%28_esiCompatHeader%29.md) (8 shared connections)

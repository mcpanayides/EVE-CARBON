...
- **fc_intel.js** (31 connections) — `src/func/fc_intel.js`
- **_intelRenderCharMenu()** (9 connections) — `src/func/fc_intel.js`
- **_intelWire()** (7 connections) — `src/func/fc_intel.js`
...
- **_intelOpenChannels()** (6 connections) — `src/func/fc_intel.js`
- **_intelAgo()** (5 connections) — `src/func/fc_intel.js`
- **_intelStartRefresh()** (5 connections) — `src/func/fc_intel.js`
- **_intelToggleCharMenu()** (5 connections) — `src/func/fc_intel.js`
...
- **_intelLoadCharacters()** (4 connections) — `src/func/fc_intel.js`
- **_intelPaintCharButton()** (4 connections) — `src/func/fc_intel.js`
- **_intelRepaintCharMenu()** (4 connections) — `src/func/fc_intel.js`
...
- **_intelCloseCharMenu()** (3 connections) — `src/func/fc_intel.js`
- **_intelMaybeCloseCharMenu()** (3 connections) — `src/func/fc_intel.js`
- **_intelPosTitle()** (3 connections) — `src/func/fc_intel.js`
- **_intelPosBadge()** (3 connections) — `src/func/fc_intel.js`

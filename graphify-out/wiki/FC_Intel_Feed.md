...
- **_intelWire()** (5 connections) — `src/func/fc_intel.js`
...
- **_intelPatPredictChip()** (2 connections) — `src/func/fc_intel_patterns.js`
...
- [FC Intel Patterns](FC_Intel_Patterns.md) (1 shared connections)

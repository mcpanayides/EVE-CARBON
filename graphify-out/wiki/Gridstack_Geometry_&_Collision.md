...
- **._packNodes()** (9 connections) — `src/vendor/gridstack/gridstack-all.js`
...
- **.restoreInitial()** (5 connections) — `src/vendor/gridstack/gridstack-all.js`
...
- **.isTouching()** (3 connections) — `src/vendor/gridstack/gridstack-all.js`
- *... and 18 more nodes in this community*

## Relationships

- [Gridstack Core & Initialisation](Gridstack_Core_%26_Initialisation.md) (29 shared connections)
- [Gridstack Touch & Drag-Drop](Gridstack_Touch_%26_Drag-Drop.md) (15 shared connections)

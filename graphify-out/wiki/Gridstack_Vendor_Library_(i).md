...
- **._createHelper()** (4 connections) — `src/vendor/gridstack/gridstack-all.js`
- **.toBool()** (3 connections) — `src/vendor/gridstack/gridstack-all.js`
...
- **.throttle()** (2 connections) — `src/vendor/gridstack/gridstack-all.js`
- **.clone()** (2 connections) — `src/vendor/gridstack/gridstack-all.js`
- **.same()** (1 connections) — `src/vendor/gridstack/gridstack-all.js`
- **.swap()** (1 connections) — `src/vendor/gridstack/gridstack-all.js`

## Relationships

- [Gridstack Core & Initialisation](Gridstack_Core_%26_Initialisation.md) (19 shared connections)
- [Gridstack Geometry & Collision](Gridstack_Geometry_%26_Collision.md) (16 shared connections)
- [Gridstack Events & Handlers](Gridstack_Events_%26_Handlers.md) (6 shared connections)

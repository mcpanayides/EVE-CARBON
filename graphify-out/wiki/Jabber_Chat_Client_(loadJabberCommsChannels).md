# Jabber Chat Client (loadJabberCommsChannels)
...
- **openPackEditor()** (6 connections) — `src/func/jabber.js`
- **populatePackDropdown()** (5 connections) — `src/func/jabber.js`
- **updatePackInfo()** (4 connections) — `src/func/jabber.js`
- **populateJabberSettings()** (3 connections) — `src/func/jabber.js`
- **_peGroupRowHtml()** (3 connections) — `src/func/jabber.js`
- **_peCommsRowHtml()** (3 connections) — `src/func/jabber.js`
- **_peAddRow()** (3 connections) — `src/func/jabber.js`
- **loadJabberCommsChannels()** (2 connections) — `src/func/jabber.js`
- **_peGatherGroups()** (2 connections) — `src/func/jabber.js`
- **_peGatherComms()** (2 connections) — `src/func/jabber.js`
- **closePackEditor()** (2 connections) — `src/func/jabber.js`

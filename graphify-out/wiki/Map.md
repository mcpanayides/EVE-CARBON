...
- **_render()** (17 connections) — `src/func/map.js`
- **_renderGalaxyModern()** (14 connections) — `src/func/map.js`
- **_w2c()** (14 connections) — `src/func/map.js`
...
- [Galaxy Map Rendering](Galaxy_Map_Rendering.md) (27 shared connections)
- [Map Viewport & Drawing](Map_Viewport_%26_Drawing.md) (7 shared connections)
- [Map](Map.md) (2 shared connections)
- [Map Routing & Menus](Map_Routing_%26_Menus.md) (1 shared connections)

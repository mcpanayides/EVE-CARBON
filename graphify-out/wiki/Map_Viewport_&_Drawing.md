...
- **_backToOverview()** (6 connections) — `src/func/map.js`
- **_fitGalaxyModern()** (6 connections) — `src/func/map.js`
- **_onResize()** (6 connections) — `src/func/map.js`
...
- [Galaxy Map Rendering](Galaxy_Map_Rendering.md) (41 shared connections)
- [Map](Map.md) (18 shared connections)
- [Map Routing & Menus](Map_Routing_%26_Menus.md) (5 shared connections)

...
- **palette.js** (20 connections) — `src/func/palette.js`
- **applyUiTransparency()** (8 connections) — `src/func/palette.js`
- **bindPaletteEvents()** (8 connections) — `src/func/palette.js`
- **applyTheme()** (6 connections) — `src/func/palette.js`
- **loadTheme()** (5 connections) — `src/func/palette.js`

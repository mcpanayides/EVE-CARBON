...
- **reactions.js** (17 connections) — `src/func/reactions.js`
- **contracts.js** (16 connections) — `src/func/contracts.js`
- **_ctRender()** (10 connections) — `src/func/contracts.js`
...
- **_rxFillModal()** (5 connections) — `src/func/reactions.js`
